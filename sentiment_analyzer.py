...
class TwitterQuery:
	...
	def get_max_sentiment(self):
		...
		sentiment_dict[len(self.negative_tweets)] = 'negative'
		sentiment_dict[len(self.neutral_tweets)] = 'neutral'
		sentiment_dict[len(self.positive_tweets)] = 'positive'
		
		key_list = sentiment_dict.keys()
		
		return sentiment_dict[max(key_list)]
